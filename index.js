...
async function initGame() {
  ...
  try {
    ...
    let gamePreIntroScene = createScene("WALKING DEAD", "Click To Continue");
    let gameStartScene = createScene("Zombie War", "Click To Start");
    let gameOverScene = createScene("Zombie War", "Game Over");
